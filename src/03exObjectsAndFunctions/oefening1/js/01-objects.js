...
// en alert de string.
let propertiesKVP = "";
for (const prop in myBicycle) {
  //console.log(`Property: ${prop}, Value: ${myBicycle[prop]}`);
  propertiesKVP += `${prop}: ${myBicycle[prop]}\n`;
}
alert(propertiesKVP);
...
console.log("gearDescription after setting to null:", gearDescription);
console.log("myBicycle after setting gearDescription to null:", myBicycle);
...
console.log(`Speed: ${speed}, Frame Material: ${frame}, Color: ${color}`);
